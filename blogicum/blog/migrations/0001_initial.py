# Generated by Django 3.2.16 on 2023-10-22 16:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(help_text='Идентификатор страницы для URL; разрешены символылатиницы, цифры, дефис и подчёркивание', unique=True, verbose_name='Идентификатор')),
            ],
            options={
